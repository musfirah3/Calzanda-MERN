...
const addOrder = async (req, res) => {
    ...
    if (!items || !totalBill || !customerAddress || !customerContact || !customerName || !customerEmail) {
        ...
        try {
            await connect(process.env.MONGO_URL)
            const order = await Orders.create({ items, totalBill, customerAddress, customerContact, customerName, customerEmail })
            //Email
...
module.exports = { placeOrder, allOrders, trackOrder, addOrder }